...
?>   
	<tr>
	<td width="10%" align="center"><?php echo $info['username']?><a href="javascript:member_infomation(<?php echo $info['userid']?>, '10', '')"><img src="<?php echo IMG_PATH?>admin_img/detail.png"></a></td>
